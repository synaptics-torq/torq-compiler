module {
  func.func @main(%arg0: tensor<1x256x1xi8>) -> tensor<1x256x1xi8> {
    %0 = "tosa.const"() <{values = dense<[[200, 100, 30, 23, 45, 65, 76, 78]]> : tensor<1x8xi32>}> : () -> tensor<1x8xi32>
    %1 = "tosa.const"() <{values = dense<[[[1], [5], [9], [13], [17], [21], [25], [29]]]> : tensor<1x8x1xi8>}> : () -> tensor<1x8x1xi8>
