module {
  func.func @main(%arg0: tensor<1x56x56x256xi8>, %arg1: tensor<1x56x56x256xi8>) -> tensor<1x56x56x256xi8> attributes {tf_saved_model.exported_names = ["serving_default"]} {
    ...
    %1 = tosa.rescale %0, %cst_3, %cst_4, %cst_5, %cst_2 {input_unsigned = false, output_unsigned = false, per_channel = false, rounding_mode = DOUBLE_ROUND, scale32 = true} : (tensor<1x56x56x256xi32>, tensor<1xi32>, tensor<1xi8>, tensor<1xi32>, tensor<1xi32>) -> tensor<1x56x56x256xi32>
    ...
    %3 = tosa.add %1, %2 : (tensor<1x56x56x256xi32>, tensor<1x56x56x256xi32>) -> tensor<1x56x56x256xi32>
