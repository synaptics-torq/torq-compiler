module {
  func.func @part2_graph(%arg0: !torch.vtensor<[1,32,112,112],si8>, %arg1: !torch.vtensor<[1,32,112,112],si8>) -> !torch.vtensor<[1,32,112,112],si8> attributes {torch.onnx_meta.ir_version = 8 : si64, torch.onnx_meta.opset_version = 17 : si64, torch.onnx_meta.producer_name = "onnx.quantize", torch.onnx_meta.producer_version = "0.1.0"} {
    ...
    %7 = torch.operator "onnx.DequantizeLinear"(%arg1, %1, %0) : (!torch.vtensor<[1,32,112,112],si8>, !torch.vtensor<[],f32>, !torch.vtensor<[],si8>) -> !torch.vtensor<[1,32,112,112],f32> 
    %8 = torch.operator "onnx.Mul"(%7, %6) : (!torch.vtensor<[1,32,112,112],f32>, !torch.vtensor<[1,32,112,112],f32>) -> !torch.vtensor<[1,32,112,112],f32> 
