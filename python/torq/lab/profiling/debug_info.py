...
import re
import torq.lab.profiling.location as loc_utils
...
def parse_profiling_log(profiling_file: str) -> List[InvocationEventData]:
    ...
    # Imported lazily so this module (and ``python -m torq.lab.profiling.perfetto``)
    # stays importable without the [profile] extra.
    import pandas as pd
