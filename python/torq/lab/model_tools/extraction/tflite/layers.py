...
"""TFLite FlatBuffer layer extraction.
...
Tensor export lives in :mod:`torq.lab.model_tools.extraction.tflite.tensors`;
TFLite-to-MLIR import in :mod:`torq.lab.model_tools.importers.tflite`.
"""
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(
            "Usage: python -m torq.lab.model_tools.extraction.tflite.layers "
            "<model.tflite> [output_dir] [max_layers]"
        )
        sys.exit(1)
