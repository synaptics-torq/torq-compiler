...
static iree_hal_torq_device_t* iree_hal_torq_device_cast(
...
static iree_status_t iree_hal_torq_device_check_params(
    const iree_hal_torq_device_params_t* params) {
...
iree_status_t iree_hal_torq_device_create(
  ...
  *out_device = NULL;
  ...
  IREE_RETURN_AND_END_ZONE_IF_ERROR(z0,
                                    iree_hal_torq_device_check_params(params));
  ...
  if (iree_status_is_ok(status)) {
    ...
    iree_hal_resource_initialize(&iree_hal_torq_device_vtable,
                                 &device->resource);
...
static iree_string_view_t iree_hal_torq_device_id(
    iree_hal_device_t* base_device) {
  iree_hal_torq_device_t* device = iree_hal_torq_device_cast(base_device);
  return device->identifier;
}

static iree_allocator_t iree_hal_torq_device_host_allocator(
    iree_hal_device_t* base_device) {
  iree_hal_torq_device_t* device = iree_hal_torq_device_cast(base_device);
  return device->host_allocator;
}

static iree_hal_allocator_t* iree_hal_torq_device_allocator(
    iree_hal_device_t* base_device) {
  iree_hal_torq_device_t* device = iree_hal_torq_device_cast(base_device);
...
static iree_status_t iree_hal_torq_device_create_event(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    iree_hal_event_flags_t flags, iree_hal_event_t** out_event) {
  return iree_hal_torq_event_create(queue_affinity, flags,
...
static iree_status_t iree_hal_torq_device_create_executable_cache(
  ...
  return iree_hal_torq_nop_executable_cache_create(base_device,
      identifier, iree_hal_device_host_allocator(base_device), out_executable_cache);
}
...
static iree_status_t iree_hal_torq_device_queue_dealloca(
  ...
  IREE_RETURN_IF_ERROR(iree_hal_device_queue_barrier(
      base_device, queue_affinity, wait_semaphore_list, signal_semaphore_list, IREE_HAL_EXECUTE_FLAG_NONE));
  return iree_ok_status();
}

static iree_status_t iree_hal_torq_device_queue_host_call(
    iree_hal_device_t* base_device, iree_hal_queue_affinity_t queue_affinity,
    const iree_hal_semaphore_list_t wait_semaphore_list,
    const iree_hal_semaphore_list_t signal_semaphore_list,
...
static iree_status_t iree_hal_torq_device_apply_deferred_command_buffer(
    iree_hal_torq_device_t* device, iree_hal_command_buffer_t* command_buffer,
  ...
  iree_host_size_t storage_size = iree_hal_torq_command_buffer_size(
  ...
  IREE_RETURN_IF_ERROR(iree_hal_torq_command_buffer_initialize(
  ...
  iree_hal_torq_command_buffer_deinitialize(inline_command_buffer);
  return status;
}
...
static iree_status_t iree_hal_torq_device_queue_execute(
  ...
  IREE_HAL_TORQ_PROFILE_STAGE_IF_OK(
      ...
      iree_hal_torq_device_apply_deferred_command_buffer(
...
static iree_status_t iree_hal_torq_device_profiling_flush(
    iree_hal_device_t* base_device) {
  // Unimplemented (and that's ok).
  return iree_ok_status();
}

static iree_status_t iree_hal_torq_device_profiling_end(
    iree_hal_device_t* base_device) {
  // Unimplemented (and that's ok).
  return iree_ok_status();
}
...
static const iree_hal_device_vtable_t iree_hal_torq_device_vtable = {
    ...
    .queue_host_call = iree_hal_torq_device_queue_host_call,
