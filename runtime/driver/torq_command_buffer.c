...
static const iree_hal_command_buffer_vtable_t
    iree_hal_torq_command_buffer_vtable;

static iree_hal_torq_command_buffer_t* iree_hal_torq_command_buffer_cast(
...
static void iree_hal_torq_command_buffer_reset(
...
iree_status_t iree_hal_torq_command_buffer_initialize(
  ...
  *out_command_buffer = NULL;
  ...
  if (storage.data_length <
      iree_hal_torq_command_buffer_size(mode, binding_capacity)) {
  ...
  iree_hal_torq_command_buffer_t* command_buffer =
      (iree_hal_torq_command_buffer_t*)storage.data;
...
iree_status_t iree_hal_torq_command_buffer_create(
  ...
  *out_command_buffer = NULL;
  ...
  iree_status_t status = iree_allocator_malloc(
      host_allocator, iree_hal_torq_command_buffer_size(mode, binding_capacity), (void**)&storage);
  iree_hal_command_buffer_t* command_buffer = NULL;
  if (iree_status_is_ok(status)) {
    status = iree_hal_torq_command_buffer_initialize(
        device_allocator, mode, command_categories, queue_affinity,
        binding_capacity, host_allocator,
        iree_make_byte_span(storage, iree_hal_torq_command_buffer_size(
...
static void iree_hal_torq_command_buffer_destroy(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_hal_torq_command_buffer_t* command_buffer =
      iree_hal_torq_command_buffer_cast(base_command_buffer);
...
static void iree_hal_torq_command_buffer_update_processor_id(
    iree_hal_torq_command_buffer_t* command_buffer) {
...
static iree_status_t iree_hal_torq_command_buffer_end(
    iree_hal_command_buffer_t* base_command_buffer) {
  iree_hal_torq_command_buffer_t* command_buffer =
      iree_hal_torq_command_buffer_cast(base_command_buffer);
  iree_hal_torq_command_buffer_reset(command_buffer);
...
static iree_status_t iree_hal_torq_command_buffer_begin_debug_group(
...
static iree_status_t iree_hal_torq_command_buffer_end_debug_group(
    iree_hal_command_buffer_t* base_command_buffer) {
  // TODO(benvanik): tracy event stack.
  return iree_ok_status();
}
...
static iree_status_t iree_hal_torq_command_buffer_advise_buffer(
    iree_hal_command_buffer_t* base_command_buffer,
...
static iree_status_t iree_hal_torq_command_buffer_copy_buffer(
  ...
  IREE_HAL_TORQ_PROFILE_STAGE_IF_OK(
      ...
      iree_hal_buffer_map_copy(source_ref.buffer, source_ref.offset,
                                  target_ref.buffer, target_ref.offset,
                                  target_ref.length));
...
static iree_status_t iree_hal_torq_command_buffer_dispatch(
  ...
  do {
    ...
    dispatch_state->constant_count = constants.data_length / sizeof(uint32_t);
...
static const iree_hal_command_buffer_vtable_t
    iree_hal_torq_command_buffer_vtable = {
        ...
        .advise_buffer = iree_hal_torq_command_buffer_advise_buffer,
